...
def main_single(rank, FLAGS):
    ...
    ## dataset
    dataset_train = RobotKeypointsDatasetGrasp('train', table_mesh=FLAGS.table_mesh)
    dataset_test = RobotKeypointsDatasetGrasp('test', table_mesh=FLAGS.table_mesh)
