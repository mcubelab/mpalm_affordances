...
def align_arm_poses(pose, grasp_dist):
    ...
    pose_right = util.convert_reference_frame(pose_right_left,
                                              util.unit_pose(),
                                              pose,
                                              "world")
...
def move_cart_synchro(palm_poses_final, plan_previous, primitive, plan_name=None, N=100, grasp_width=0.1, is_replan=False):
    ...
    palm_pose_left_world_list = util.interpolate_pose(pose_initial_left_world,
    ...
    for palm_pose_l_world in palm_pose_left_world_list:
        pose_list_world = align_arm_poses(palm_pose_l_world,
                                          grasp_width)
