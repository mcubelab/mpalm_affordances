...
# _C.OBSERVATION_DIR = 'catkin_ws/src/primitives/observations_h'
# _C.PREDICTION_DIR = 'catkin_ws/src/primitives/predictions_h'
_C.OBSERVATION_DIR = '/tmp/observations'
_C.PREDICTION_DIR = '/tmp/predictions'
