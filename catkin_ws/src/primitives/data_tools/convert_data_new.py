...
#    pickle_base = "/data/scratch/asimeonov/repos/research/mpalm_affordances/catkin_ws/src/primitives/data/grasp/grasping_ycb_init"
#    pickle_base = "/data/scratch/asimeonov/repos/research/mpalm_affordances/catkin_ws/src/primitives/data/grasp/grasping_cuboid_45"
    pickle_base = "/root/catkin_ws/src/primitives/data/push/pushing_cuboid_init"
    ...
    #numpy_files = "/data/scratch/asimeonov/repos/research/mpalm_affordances/catkin_ws/src/primitives/data/grasp/numpy_grasp_ycb_0/"
    numpy_files = "/root/catkin_ws/src/primitives/data/push/numpy_push_cuboid_0/"
    ...
    for i, pickle_files in enumerate(all_pickle_files):
        for pf in tqdm(pickle_files):
            ...
            # mesh_file = data['mesh_file'].split('objects/ycb_objects/')[1]
            ...
            table_pointcloud = np.concatenate(pcd_data['table_pts'], axis=0)
